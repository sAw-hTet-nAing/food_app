...
class Dimensions {
  ...
  //List view size
  static double ListViewImgSize = screeWidth / 1.5;
  static dynamic ListViewTextSize = screeWidth / 3;
  ...
  //bottom height
  static double bottomHeightbar = screeHigh / 6.5;
  //text high
  static double exptextHigh = screeHigh / 3.58;
